...
<div class="container mb-5">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form class="row" action="{{route('Saveedaboutsus')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_1" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus futhre_2 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_2" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus futhre_3 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_3" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus futhre_4 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_4" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_6" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus futhre_7 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_7" aria-describedby="emailHelp"   >
                </div>
               
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus futhre_8 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="futhre_8" aria-describedby="emailHelp"   >
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_title_1 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_title_1" aria-describedby="emailHelp"   >
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_1 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_1" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_title_2 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_title_2" aria-describedby="emailHelp"   >
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_2 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_2" aria-describedby="emailHelp"   >
                </div>
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_title_3 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_title_3" aria-describedby="emailHelp"   >
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="exampleInputEmail1" class="form-label">aboutsus number_3 </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="number_3" aria-describedby="emailHelp"   >
                </div>
