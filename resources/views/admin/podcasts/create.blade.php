...
<div class="container mb-5">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form class="row" action="{{route('Saveedpodcasts')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">podcasts Url</label>
                    <input type="url" class="form-control" id="exampleInputEmail1" required name="url" aria-describedby="emailHelp" >
              
                </div>
                
                <div class="col-md-12 mt-3 mb-3">
                    <button type="submit" class="btn btn-primary">Saved podcasts </button>
                </div>
            </form>
        </div>
