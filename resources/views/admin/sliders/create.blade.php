...
<div class="container mb-5">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form class="row" action="{{route('SaveedSliders')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="file" class="form-control" id="exampleInputEmail1" name="image_2" required aria-describedby="emailHelp" >
              
                </div>
                <div class="col-md-12 mt-3 mb-3">
                    <button type="submit" class="btn btn-primary">Saved Sliders </button>
                </div>
            </form>
        </div>
