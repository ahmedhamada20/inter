...
<div class="container mb-5">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form class="row" action="{{route('updatednews')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="by_name" value="{{$data->by_name}}" aria-describedby="emailHelp"   >
                </div>
               
                <div class="col-md-12 mb-3">
                    <label for="exampleInputEmail1" class="form-label">news by category</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="by_category" value="{{$data->by_category}}" aria-describedby="emailHelp"   >
                </div>
