        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="footer-logo-area">
                    <a href="index.html"><img src="{{ asset('front/assets/images/white-logo.png') }}" alt="Image"></a>
                    ...
                    <div class="contact-list">
                        <ul>
                            ...
                            <li><a
                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#b7d6d3daded9f7c4d6d9c299d2d3c2"><span
                                        class="__cf_email__"
                                        data-cfemail="cbaaafa6a2a58bb8aaa5bee5aeafbe">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
